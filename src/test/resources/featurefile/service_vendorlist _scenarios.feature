...
Feature: Verify admin can see all available service vendor list and category and subcategory list
  ...
  Background:
    ...
    And admin clicks on service vendor list link
      ...
      | email |
      | test  |
  --> Your 'Then' step has an 'and', you cannot have 2 steps in 1.
  Following on, your last step isn't necessary.
  ...
  --> Your 'When' step has incorrect grammar, please ensure this isn't the case from now on.
  ...
  --> Again, spacing and formatting is making this difficult to read
